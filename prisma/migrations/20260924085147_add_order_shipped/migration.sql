...
INSERT INTO "new_Order" ("amountTotal", "billingAddressLine1", "billingAddressLine2", "billingCity", "billingCountry", "billingPostalCode", "createdAt", "currency", "customerEmail", "customerName", "customerPhone", "id", "invoicePdfUrl", "invoiceUrl", "orderNumber", "productId", "productTitle", "receiptUrl", "shippingAddressLine1", "shippingAddressLine2", "shippingCity", "shippingCountry", "shippingName", "shippingPostalCode", "status", "stripePaymentIntentId", "stripeSessionId", "type", "voucherCode", "voucherMessage", "voucherRecipientName", "voucherRedeemed", "voucherRedeemedAt") SELECT "amountTotal", "billingAddressLine1", "billingAddressLine2", "billingCity", "billingCountry", "billingPostalCode", "createdAt", "currency", "customerEmail", "customerName", "customerPhone", "id", "invoicePdfUrl", "invoiceUrl", "orderNumber", "productId", "productTitle", "receiptUrl", "shippingAddressLine1", "shippingAddressLine2", "shippingCity", "shippingCountry", "shippingName", "shippingPostalCode", "status", "stripePaymentIntentId", "stripeSessionId", "type", "voucherCode", "voucherMessage", "voucherRecipientName", "voucherRedeemed", "voucherRedeemedAt" FROM "Order";
DROP TABLE "Order";
